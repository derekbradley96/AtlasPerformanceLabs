-- FINAL SAFETY: ensure every public foreign key has a covering index.
-- This migration only ADDS missing FK indexes and never drops indexes.
-- It is idempotent and resilient to schema drift.

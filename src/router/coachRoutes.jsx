...
export default function CoachRoutes({
  ...
  return (
    <>
      ...
      <Route path="clients/:id/pose-timeline" element={<RequireRole allow={[Roles.COACH, Roles.ADMIN]} accessDeniedMessage="Pose Timeline is for coaches only."><PoseTimelinePage /></RequireRole>} />
      ...
      <Route path="review-center/pose-checks" element={<RequireRole allow={[Roles.COACH, Roles.ADMIN]} accessDeniedMessage="Pose check review is for coaches only."><PoseCheckReviewPage /></RequireRole>} />
      <Route path="review-center/pose-checks/:poseCheckId" element={<RequireRole allow={[Roles.COACH, Roles.ADMIN]} accessDeniedMessage="Pose check review is for coaches only."><PoseCheckReviewDetailPage /></RequireRole>} />
      ...
      <Route path="prep-dashboard/roster" element={<RequireRole allow={[Roles.COACH, Roles.ADMIN]} accessDeniedMessage="Prep Dashboard is for coaches only."><PrepDashboardPage /></RequireRole>} />
      <Route path="prep-dashboard" element={<RequireRole allow={[Roles.COACH, Roles.ADMIN]} accessDeniedMessage="Prep Dashboard is for coaches only."><CoachPrepHubPage /></RequireRole>} />
      ...
      <Route path="prep-timeline" element={<RequireRole allow={[Roles.COACH, Roles.ADMIN]} accessDeniedMessage="Prep timeline is for coaches only."><CoachPrepTimelineBoard /></RequireRole>} />

...
export const ROUTE_TABLE = [
  ...
  { path: '/login', roles: 'public', label: 'Login (redirects to /auth)' },
  ...
  { path: '/clients/:id/review-center', roles: 'coach', label: 'Client review' },
  ...
  { path: '/review-center', roles: 'coach', label: 'Review queue' },
  ...
  { path: '/get-clients', roles: 'coach', label: 'Get Clients' },
  { path: '/inviteclient', roles: 'coach', label: 'Get Clients (alias)' },
  ...
  { path: '/coach-onboarding-flow', roles: 'coach', label: 'Coach onboarding' },
  { path: '/coach-onboarding', roles: 'coach', label: 'Legacy → coach onboarding' },
  { path: '/setup', roles: 'coach', label: 'Legacy → coach onboarding' },
  { path: '/trainer-setup', roles: 'coach', label: 'Legacy → coach onboarding' },
  { path: '/coach-type', roles: 'coach', label: 'Legacy → coach onboarding' },
  { path: '/global-review', roles: 'coach', label: 'Review redirect' },
  { path: '/review-global', roles: 'coach', label: 'Review next' },
  ...
  { path: '/workout', roles: 'any', label: 'Workout (legacy redirect)' },
  { path: '/workout-player', roles: 'any', label: 'Workout Player' },
  { path: '/progress', roles: 'any', label: 'Progress' },
  { path: '/findtrainer', roles: 'any', label: 'Find a coach (redirects)' },
  ...
  { path: '/prep-precision', roles: 'any', label: 'Prep precision (gated)' },
  { path: '/prep-dashboard', roles: 'coach', label: 'Prep Dashboard' },
  { path: '/nutrition-targets', roles: 'personal', label: 'Nutrition targets' },

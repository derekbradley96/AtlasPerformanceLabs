...
const TYPE_TO_CATEGORY = {
  ...
  community_mention: NOTIFICATION_CATEGORIES.ENGAGEMENT,
  ...
  payment_reminder_auto: NOTIFICATION_CATEGORIES.ACTION_REQUIRED,
  coach_pending_draft: NOTIFICATION_CATEGORIES.ACTION_REQUIRED,
};
